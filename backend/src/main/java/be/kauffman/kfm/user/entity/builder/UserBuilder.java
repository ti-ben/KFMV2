...
public class UserBuilder {
    ...
    public User build() {
        return new User(user_id, firstname, lastname, gender, avatar, dob, email, password, telpro, telperso, nationality, numirn, driver_license, created_on, pob, active, site, addressList, grade, status);
    }
