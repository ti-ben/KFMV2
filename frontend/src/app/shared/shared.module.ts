...
} from './component/with-menu-and-destroyable/with-menu-and-destroyable.component';
...
@NgModule({
  declarations: [
    ...
    CardComponent,
    CardHeaderComponent,
    ButtonIconComponent, WithMenuAndDestroyableBaseComponent, InputTextComponent, InputDateComponent, TextareaComponent, SelectComponent
  ],
  exports: [
    ErrorLandingPageComponent,
    GenericDataTableComponent,
